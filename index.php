...
<body>
    <header>
        ...
        <nav class="navbar container-menu py-3 fixed-top">
            <div class="container">
                <a target="_blank" class="navbar-brand" href="#"><img src='<?php echo get_template_directory_uri()?>/assets/imgs/logo.svg' alt='Logo AWE'> 
                </a>
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            ...
                            <li class="nav-item">
                                <a target="_blank" class="nav-link" href="#">Link</a>
                            </li>
                            <li class="nav-item dropdown">
                                <a target="_blank" class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                                    aria-expanded="false">
                                    Dropdown
                                </a>
                                <ul class="dropdown-menu">
                                    <li><a target="_blank" class="dropdown-item" href="#">Action</a></li>
                                    <li><a target="_blank" class="dropdown-item" href="#">Another action</a></li>
                                    <li>
                                        <hr class="dropdown-divider">
                                    </li>
                                    <li><a target="_blank" class="dropdown-item" href="#">Something else here</a></li>
                                </ul>
                            </li>
                        </ul>
            ...
            <div class="container d-flex flex-column">
                ...
                <section class="top d-flex gap-4 row">
                    ...
                    <div class="content_top gap-3 col col-sm-10 col-lg-7 d-flex flex-column gap-3">
                        ...
                        <a target="_blank" href="src/about.html" class="fs-6 fw-bold text-decoration-none">Quer saber mais sobre o que fazemos?
                            <br>#PorDentroDaAWE</a>
                    </div>
                </section>
                    ...
                    <div class="project col-3 d-flex flex-column gap-3">
                        ...
                        <div class="content-text-project">
                            ...
                            <p class="description-project fs-6">História em Detalhes é um blog sobre histórias, crônicas
                                e outras histórias do professor e escritor Sérgio Trindade. </p>
                        </div>
                        <a target="_blank" href="#">Acesse o projeto</a>
                    </div>
                    <div class="project col-3 d-flex flex-column gap-3">
    ...
    <footer>
        <section class="contact-instagram">
            <div class="container flex-column d-flex align-items-center gap-3 py-5">
                <span class="link-instagram d-flex gap-2">
                    <a target="_blank" href="https://www.instagram.com/awescolar.ifrn?igsh=b2kzdGhlZWMxbWll" target="_blank">
        ...
        <section class="content-footer">
            <div class="container pt-5 d-flex flex-column gap-5 px-4">
                <p class="text"><span>Queremos você aqui</span>. Que tal você fazer parte da nossa equipe e mudarmos o
                    mundo,
                    <span>juntos</span>?
                </p>
                <section class="links-contatcs d-flex gap-4 row">
                    ...
                    <div class="media links d-flex flex-column gap-2">
                        ...
                        <ul class="d-flex gap-4 align-items-center">
                            <li><a target="_blank" href="https://www.instagram.com/awescolar.ifrn/?igsh=b2kzdGhlZWMxbWll"><i class="fa-brands fa-instagram"></i></a></li>
                            <li><a target="_blank" href="https://dribbble.com/awescolar"><i class="fa-brands fa-dribbble"></i></a></li>
                            <li><a target="_blank" href="https://www.behance.net/gallery/110915853/Agencia-Web-Escolar"><i class="fa-brands fa-behance"></i></a></li>
                            <li><a target="_blank" href="https://github.com/awescolar"><i class="fa-brands fa-github"></i></a></li>
                            <li><a target="_blank" href="https://www.linkedin.com/company/agencia-web-escolar/"><i class="fa-brands fa-linkedin-in"></i></a></li>
                        </ul>
                    </div>
                </section>
            </div>
