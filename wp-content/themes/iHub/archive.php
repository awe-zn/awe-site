...
<main class="container news my-5">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><?php _e('Principais atualizações Smart Metrópolis iHub', 'ihub'); ?></li>
        </ol>
    </nav>
    ...
    <section class="list-news">
        ...
        <header>
            <h1><?php _e('Principais atualizações Smart Metrópolis iHub', 'ihub'); ?></h1>
        </header>     
