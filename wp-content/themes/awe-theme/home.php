    ...
    <section class="team">
        <div class="container">
            <div class="row flex-column d-flex">
                ...
                <a class="btn-2 text-decoration-none text-uppercase d-flex align-items-center mt-4 fw-bold px-4 py-3 rounded-3 gap-4 me-auto w-auto" href="<?php echo get_template_directory_uri(); ?>/team">conhecer
                    time completo
